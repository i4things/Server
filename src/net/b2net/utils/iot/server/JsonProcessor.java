...
class JsonProcessor
{
    ...
    String process(String r, AtomicBoolean err)
    {
        try
        {
            String ret = null;
...
// IoT Section
        ...
        {  // IoT device history
            ...
            if (token.length > 2)
            {
                ...
                ret = store.get_iot_hist(device_id, day_idx, token[2], err);
            }
        }                    //012345678
        ...
        {   // IoT device data for the day
            ...
            if (token.length > 1)
            {
                ...
                ret =  store.get_iot_get(device_id, token[1], false, 0, err);
            }
        }                    //01234567890123
        ...
        {   // IoT device data for the day
            ...
            if (token.length > 1)
            {
                ...
                ret = store.get_iot_get(device_id, token[1], true, 0, err);
            }
        }                    //01234567890123
        ...
        {   // IoT device data for the day
            ...
            if (token.length > 2)
            {
                ...
                ret = store.get_iot_get(device_id, token[2], false, from, err);
            }
        }                      //012345678
        ...
        {   // IoT device data for the day
            ...
            if (token.length > 2)
            {
                ...
                ret = store.get_iot_set(device_id, token[1], token[2], err);
            }
        ...
        else if (r.startsWith("/mc_iot_gateway_data/"))
        {
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_gateway_data(id, token[1], err);
                }
            }
        }                    //1234567890123
        else if (r.startsWith("/mc_iot_data/"))
        {
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_node_data(id, token[1], err);
                }
            }
        ...
        {   // Management API - register facilitator
            ...
            if (token.length > 1)
            {
                ret = store.get_mc_reg_facilitator(token[1], err);
            }
        }                    //1234567890123456
        ...
        {   // Management API - register account
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_reg_account(id, token[1], err);
                }
            }
        }                    //1234567890123
        ...
        {   // Management API - register node
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_reg_node(id, token[1], err);
                }
            }
        }                    //1234567890123456
        ...
        {   // Management API - register gateway
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_reg_gateway(id, token[1], err);
                }
            }
        }                    //1234567890123456
        ...
        {   // Management API - delete gateway
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_del_gateway(id, token[1], err);
                }
            }
        }                    //1234567890123
        ...
        {   // Management API - delete node
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_del_node(id, token[1], err);
                }
            }
        }                    //1234567890123456
        ...
        {   // Management API - delete account
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_del_account(id, token[1], err);
                }
            }
        }                    //12345678901234567890
        ...
        {   // Management API - delete facilitator
            ...
            if (token.length > 1)
            {
                ret = store.get_mc_del_facilitator(token[1], err);
            }
        ...
        {   // Management API - get facilitator
            ...
            if (token.length > 1)
            {
                ret = store.get_mc_get_facilitator(token[1], err);
            }
        ...
        {   // Management API - get account
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_get_account(id, token[1], err);
                }
            }
        }                    //1234567890123456
        ...
        {   // Management API - get gateway
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_get_gateway(id, token[1], err);
                }
            }
        }                    //1234567890123
        ...
        {   // Management API - get node
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_get_node(id, token[1], err);
                }
            }
        ...
        {   // Management API - get gateway details
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_get_gateway_details(id, token[1], err);
                }
            }
        }                    //123456789012345678901
        ...
        {   // Management API - get node details
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_get_node_details(id, token[1], err);
                }
            }
        }                    //123456789012345678901234
        ...
        {   // Management API - get account details
            ...
            if (r.length() > 38)
            {
                ...
                if (token.length > 1)
                {
                    ret = store.get_mc_get_account_details(id, token[1], err);
                }
            }
        ...
        {   // Management API - dget facilitatordetails
            ...
            if (token.length > 1)
            {
                ret = store.get_mc_get_facilitator_details(token[1], err);
            }
